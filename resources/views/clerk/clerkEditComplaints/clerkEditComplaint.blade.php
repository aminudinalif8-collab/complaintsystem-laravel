...
<div class="edit-container">
    ...
    <div class="edit-card">
        ...
        <div class="complaint-hero">
            <div class="complaint-meta">
                <span class="complaint-id">
                    ...
                    Complaint ID: C{{ $complaint->complaintID }}
                </span>
        ...
        <div class="form-section">
            <form action="{{ route('clerk.updateComplaint', $complaint->complaintID) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-grid">
                    <!-- Title -->
            ...
            <!-- Hidden Delete Form -->
            <form id="cancelComplaintForm" action="{{ route('clerk.cancelComplaint', $complaint->complaintID) }}" method="POST" style="display:none;">
                @csrf
            </form>
        </div>
    </div>
...
<script>
    ...
    function goBack() {
        window.location.href = "{{ route('clerk.myComplaintsClerk') }}";
    }
