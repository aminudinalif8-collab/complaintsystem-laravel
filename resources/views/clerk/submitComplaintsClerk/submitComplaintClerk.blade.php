...
<div class="main-content">
    ...
    <div class="header-row">
        <div class="title-section">
            <h1><i class="fas fa-ticket-alt" style="color: var(--primary);"></i> Submit Complaint</h1>
    ...
    <div id="submitSection">
        <div class="form-card">
            ...
            <div class="form-body">
                <form action="{{ route('clerk.submitComplaint.store') }}" method="POST" enctype="multipart/form-data" id="complaintForm">
                    @csrf
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-row">
                            ...
                            <div class="file-upload-area" id="fileUploadArea">
                                ...
                                <input type="file" name="complaintEvidence" id="fileInput" class="file-input" accept="image/jpeg,image/png,image/jpg,application/pdf">
                            </div>
...
<script>
    ...
    Swal.fire({
        ...
        confirmButtonText: 'View My Complaints',
        confirmButtonColor: '#2C6E5C',
        allowOutsideClick: false,
        borderRadius: '16px'
    }).then((result) => {
        if (result.isConfirmed) {
            window.location.href = "{{ route('clerk.myComplaints') }}";
        }
    });
    @endif
