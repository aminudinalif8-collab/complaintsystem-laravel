...
<div class="main-content">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('manager.viewComplaints') }}" class="back-btn">
    ...
    <div class="edit-card">
        ...
        <div class="form-section">
            <form id="complaintForm" action="{{ route('manager.updateComplaint', $complaint->complaintID) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-row">
                        <label><i class="fas fa-user-check"></i> Supervisor</label>
                        <div style="padding: 12px 16px; border-radius: var(--radius-md); border: 1.5px solid var(--gray-300); background: var(--gray-50); font-size: 0.9rem; color: var(--gray-600);">
                            ...
                            @else
                                <span style="color: var(--gray-400);">Manager Authority</span>
                            @endif
                        </div>
                    ...
                    <div class="row-2cols">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" value="{{ $complaint->employee->employeeName ?? 'N/A' }} ({{ $complaint->employee->formatted_employee_id ?? 'N/A' }})" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="action-buttons">
                        @if($isEditable)
                            ...
                            <button type="button" class="btn-cancel" id="backBtn">
                                <i class="fas fa-times"></i> Back to Complaints
                            </button>
                            <button type="button" class="btn-delete" id="cancelComplaintBtn">
            ...
            <!-- Hidden Cancel Form -->
            <form id="cancelForm" action="{{ route('manager.cancelComplaint', $complaint->complaintID) }}" method="POST" style="display:none;">
                @csrf
            </form>
        </div>
    </div>
        ...
        if (cancelBtn) {
            cancelBtn.addEventListener('click', () => {
                Swal.fire({
                    ...
                    text: 'This will mark the complaint as Cancelled.',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#e4685b',
