...
<head>
    ...
    <button class="mobile-sidebar-toggle" type="button" aria-label="Open navigation" aria-controls="managerSidebar" aria-expanded="false">
    ...
    <div class="sidebar" id="managerSidebar">
        <div class="sidebar-header">
            <h2><i class="fas fa-chart-line"></i> <span>Manager Portal</span></h2>
            <p><span>Complaint System Manager</span></p>
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('manager.viewComplaints') }}" class="nav-link {{ request()->routeIs('manager.viewComplaints') ? 'active' : '' }}">
                    <i class="fas fa-ticket-alt"></i> <span>View Complaints</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('manager.pendingApproval') }}" class="nav-link {{ request()->routeIs('manager.pendingApproval') ? 'active' : '' }}">
                    <i class="fas fa-check-double"></i> <span>Pending Approvals</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('manager.manageUsers') }}" class="nav-link {{ request()->routeIs('manager.manageUsers') ? 'active' : '' }}">
                    <i class="fas fa-users"></i> <span>Manage Users</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('manager.generateReport') }}" class="nav-link {{ request()->routeIs('manager.generateReport') ? 'active' : '' }}">
