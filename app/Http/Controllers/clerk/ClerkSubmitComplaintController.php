...
class ClerkSubmitComplaintController extends Controller
{
    // SHOW FORM
    public function index()
    {
        ...
        return view('clerk.submitComplaintsClerk.submitComplaintClerk', compact('employee', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('clerk.myComplaintsClerk')->with('success', 'Complaint submitted successfully!');
    }
}