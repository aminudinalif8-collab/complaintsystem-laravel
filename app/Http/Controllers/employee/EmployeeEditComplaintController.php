...
class EmployeeEditComplaintController extends Controller
{
    /**
    ...
    public function index($id)
    {
        ...
        return view('employee.editComplaints.editComp', compact('complaint', 'categories', 'employee', 'supervisor', 'isEditable'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Recalculate priority based on updated data
        $priorityService = new PriorityService();
        $complaint->complaintPriority = $priorityService->calculatePriority(
            $request->complaintTitle,
            $request->complaintDescription,
            $request->complaintCategory,
            $complaint->complaintEvidence || $request->hasFile('complaintEvidence')
        );
